...
class SpatioTemporalFocalModulation(nn.Module):
    def __init__(self, dim, focal_window, focal_level, focal_factor=2, bias=True, proj_drop=0.,
        ...
        # Temporal modulation layers for hierarchical attention
        ...
        # Attention windows and hierarchy
        self.kernel_sizes = []
    ...
    def forward(self, x):
        ...
        # Temporal context aggregation (multi-level)
        ctx_all_temporal = 0
        ...
        # Spatial context aggregation (multi-level)
        ctx_all = 0
        for l in range(self.focal_level):         
